...
public class ControlsPanelold extends JPanel {
	...
	private void init(PianoLED pianoLED) {
		...
		pnl_LeftLabels.setLayout(new GridLayout(12, 0, 0, 0));
		...
		JLabel lblNewLabel_1_7 = new JLabel("BG LED:");
		...
		JLabel lblNewLabel_1_8 = new JLabel("Fix LED:");
		...
		JLabel lblNewLabel_1_9 = new JLabel("Reverse LED:");
		...
		JLabel lbGuide = new JLabel("Guide LED:");
		lbGuide.setForeground(Color.WHITE);
		lbGuide.setFont(new Font("Tahoma", Font.BOLD, 25));
		pnl_LeftLabels.add(lbGuide);

		JPanel pnl_RightControls = new JPanel();
		pnl_RightControls.setBackground(new Color(0, 0, 0));
		pnl_Controls.add(pnl_RightControls);
		pnl_RightControls.setLayout(new GridLayout(12, 0, 0, 0));
		...
		sld_Brightness.setPaintLabels(true);
		sld_Brightness.setBackground(Color.BLACK);
		sld_Brightness.setForeground(Color.WHITE);
		sld_Brightness.setMajorTickSpacing(51);
		sld_Brightness.setPaintTicks(true);
		...
		sld_Fade.setPaintLabels(true);
		sld_Fade.setBackground(Color.BLACK);
		sld_Fade.setForeground(Color.WHITE);
		sld_Fade.setMajorTickSpacing(51);
		sld_Fade.setPaintTicks(true);
		...
		sld_SplashMaxLenght.setPaintLabels(true);
		sld_SplashMaxLenght.setBackground(Color.BLACK);
		sld_SplashMaxLenght.setForeground(Color.WHITE);
		sld_SplashMaxLenght.setMajorTickSpacing(2);
		sld_SplashMaxLenght.setPaintTicks(true);
		...
		panel_1_8.add(reverseToggle);

		JPanel pnl_Guide = new JPanel();
		pnl_Guide.setBackground(Color.BLACK);
		pnl_RightControls.add(pnl_Guide);
		pnl_Guide.setLayout(new GridLayout(1, 0, 0, 0));

		guideToggle.setBorderPainted(false);
		guideToggle.setFocusable(false);
		pnl_Guide.add(guideToggle);
		...
		JPanel pnl_GuideControls = new JPanel();
		pnl_GuideControls.setBackground(Color.BLACK);
		tabbedPane.addTab("Guide Controls", null, pnl_GuideControls, null);
		pnl_GuideControls.setLayout(new GridLayout(1, 1)); // Set GridLayout with 1 row and 2 columns

		pnl_GuideControls.add(guidePanel);

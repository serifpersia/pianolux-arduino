...
public class WebcamSettingsPanel extends JPanel {
	...
	public WebcamSettingsPanel() {
		...
		JTextField[] textFields = { new JTextField("0"), new JTextField("0"), new JTextField("0"), new JTextField("0") };
		...
		JButton btnMirror_X = new JButton("Mirror X");
		btnMirror_X.setBackground(new Color(231, 76, 60));
		btnMirror_X.setForeground(new Color(255, 255, 255));
		btnMirror_X.setFont(new Font("Tahoma", Font.BOLD, 20));
		topButtonsPane.add(btnMirror_X);

		JButton btnMirrorY = new JButton("Mirror Y");
		btnMirrorY.setForeground(new Color(255, 255, 255));
		btnMirrorY.setBackground(new Color(231, 76, 60));
		btnMirrorY.setFont(new Font("Tahoma", Font.BOLD, 20));
		topButtonsPane.add(btnMirrorY);

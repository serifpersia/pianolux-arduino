...
List<String> m = Arrays.asList("Default", "Splash", "Random", "Gradient", "Velocity", "Split", "Animation", "Piano Roll");
...
public JSONObject getLatestRelease(String url) {
  try {
    ...
    //conn.setRequestProperty("Authorisation", "token " + authToken); // set the authorisation header with your PAT
...
public Button addButton(ControlP5 cp5, String name, String label, int x, int y, int w, int h, int fg, int bg, int act)
{
...
// SCrollable List
public ScrollableList addScrollableList(ControlP5 cp5, String name, String label, List<String> items, int defItem, int x, int y, int w, int h, int barH, int itemH)
{
  return addScrollableList(cp5, name, label, items, defItem, x, y, w, h, barH, itemH, APP_COLOR_FG, APP_COLOR_BG, APP_COLOR_ACT);
}

public ScrollableList addScrollableList(ControlP5 cp5, String name, String label, List<String> items, int defItem, int x, int y, int w, int h, int barH, int itemH, int fg, int bg, int act)
{
...
public Slider addSlider( ControlP5 cp5, String name, String label, int x, int y, int h, int w, float min, float max, float def)
{
  return addSlider( cp5, name, label, x, y, h, w, min, max, def, SLIDER_COLOR_FG, SLIDER_COLOR_BG, SLIDER_COLOR_ACT);
}

public Slider addSlider( ControlP5 cp5, String name, String label, int x, int y, int h, int w, float min, float max, float def, int fg, int bg, int act)
{
...
//Toggles
public Toggle addToggle(ControlP5 cp5, String name, String label, int x, int y, int w, int h, int fg, int bg, int act)
{
  ...
  public void settings() { size(930, 160); }
